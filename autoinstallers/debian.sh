...
sudo pixiecore -initrd debian/initrd.gz -kernel debian/linux -cmdline="auto=true locale=en_US keyboard-configuration/xkb-keymap=us hw-detect/load_firmware=false netcfg/choose_interface=auto hostname=debian domain=klouds.org url=http://192.168.100.2:8080/debianpreseed.cfg"
